...
class Plotter:
    ...
    def __init__(self, result_path, model_id='-1'):
        ...
        elif "SMAP" in self.result_path or "MSL" in self.result_path or "ASC" in self.result_path:
    ...
    def _load_results(self):
        ...
        if 'SMAP' in self.result_path or 'MSL' in self.result_path or "ASC" in self.result_path:
